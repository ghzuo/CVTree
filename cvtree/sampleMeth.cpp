...
string Bootstrap::label() { return name; };
...
string Jackknife::ratioStr() {
  stringstream str;
  str << fixed << setprecision(2) << ratio;
  return str.str();
};

string Jackknife::label() { return name + "-" + ratioStr(); };
string Jackknife::wkdir() { return name + "/" + ratioStr(); };
